...
word_list = ["accident", "banana", "murder", "aeroplane", "competition", "exibition", "throwback", "manipulation", "huricane", "asteroid","facilitate", "original", "ability", "purity", "chemical","altitude", "gratitude", "pedicure", "quantity", "comical", "hesitate", "helicopter", "pessimist", "clerical", "authority", "president", "identical", "sesibility", "historical", "certificate", "magnificent", "electricity", "medicine", "ventilate", "estimate", "difficult", "optimist", "humidity", "nautical"]
count = 0
score = 0
